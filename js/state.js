...
const ACHIEVEMENTS = [
    // Vibe milestones
    { id: 'vibe_1k',      name: 'Getting Started',    desc: 'Earn 1K total vibes', icon_img: 'sprites/images/icons/achievements/ach_vibe_1k.webp',         icon: '⭐', threshold: { type: 'lifetime', value: 1_000 } },
    { id: 'vibe_10k',     name: 'Five Figures',       desc: 'Earn 10K total vibes', icon_img: 'sprites/images/icons/achievements/ach_vibe_10k.webp',        icon: '🔸', threshold: { type: 'lifetime', value: 10_000 } },
    { id: 'vibe_100k',    name: 'Six Figures',        desc: 'Earn 100K total vibes', icon_img: 'sprites/images/icons/achievements/ach_vibe_100k.webp',       icon: '🔶', threshold: { type: 'lifetime', value: 100_000 } },
    { id: 'vibe_1m',      name: 'Vibe Millionaire',   desc: 'Earn 1M total vibes', icon_img: 'sprites/images/icons/achievements/ach_vibe_1m.webp',         icon: '🌟', threshold: { type: 'lifetime', value: 1_000_000 } },
    { id: 'vibe_10m',     name: 'Deca-Million',       desc: 'Earn 10M total vibes', icon_img: 'sprites/images/icons/achievements/ach_vibe_10m.webp',        icon: '💫', threshold: { type: 'lifetime', value: 10_000_000 } },
    { id: 'vibe_100m',    name: 'Hecto-Million',      desc: 'Earn 100M total vibes', icon_img: 'sprites/images/icons/achievements/ach_vibe_100m.webp',       icon: '✨', threshold: { type: 'lifetime', value: 100_000_000 } },
    { id: 'vibe_1b',      name: 'Billion Vibes',      desc: 'Earn 1B total vibes', icon_img: 'sprites/images/icons/achievements/ach_vibe_1b.webp',         icon: '💎', threshold: { type: 'lifetime', value: 1_000_000_000 } },
    { id: 'vibe_10b',     name: 'Ten Billion Club',   desc: 'Earn 10B total vibes', icon_img: 'sprites/images/icons/achievements/ach_vibe_10b.webp',        icon: '🔮', threshold: { type: 'lifetime', value: 10_000_000_000 } },
    { id: 'vibe_100b',    name: 'Hundred Billion',    desc: 'Earn 100B total vibes', icon_img: 'sprites/images/icons/achievements/ach_vibe_100b.webp',       icon: '🌠', threshold: { type: 'lifetime', value: 100_000_000_000 } },
    { id: 'vibe_1t',      name: 'Trillionaire',       desc: 'Earn 1T total vibes', icon_img: 'sprites/images/icons/achievements/ach_vibe_1t.webp',         icon: '👑', threshold: { type: 'lifetime', value: 1_000_000_000_000 } },
    { id: 'vibe_10t',     name: 'Ten Trillion',       desc: 'Earn 10T total vibes', icon_img: 'sprites/images/icons/achievements/ach_vibe_10t.webp',        icon: '🎯', threshold: { type: 'lifetime', value: 10_000_000_000_000 } },
    { id: 'vibe_100t',    name: 'Quad Vibes',         desc: 'Earn 100T total vibes', icon_img: 'sprites/images/icons/achievements/ach_vibe_100t.webp',       icon: '🪐', threshold: { type: 'lifetime', value: 100_000_000_000_000 } },
    // Click milestones
    { id: 'click_50',     name: 'First Clicks',       desc: 'Click 50 times', icon_img: 'sprites/images/icons/achievements/ach_click_50.webp',              icon: '☝️', threshold: { type: 'clicks', value: 50 } },
    { id: 'click_100',    name: 'Finger Exercise',    desc: 'Click 100 times', icon_img: 'sprites/images/icons/achievements/ach_click_100.webp',             icon: '👆', threshold: { type: 'clicks', value: 100 } },
    { id: 'click_500',    name: 'Getting Rhythm',     desc: 'Click 500 times', icon_img: 'sprites/images/icons/achievements/ach_click_500.webp',             icon: '🎵', threshold: { type: 'clicks', value: 500 } },
    { id: 'click_1k',     name: 'Clickathon',         desc: 'Click 1,000 times', icon_img: 'sprites/images/icons/achievements/ach_click_1k.webp',           icon: '🎪', threshold: { type: 'clicks', value: 1_000 } },
    { id: 'click_10k',    name: 'Carpal Tunnel',      desc: 'Click 10,000 times', icon_img: 'sprites/images/icons/achievements/ach_click_10k.webp',          icon: '🖱️', threshold: { type: 'clicks', value: 10_000 } },
    { id: 'click_100k',   name: 'Click Obsession',    desc: 'Click 100,000 times', icon_img: 'sprites/images/icons/achievements/ach_click_100k.webp',         icon: '🌀', threshold: { type: 'clicks', value: 100_000 } },
    { id: 'click_1m',     name: 'Click Addict',       desc: 'Click 1,000,000 times', icon_img: 'sprites/images/icons/achievements/ach_click_1m.webp',       icon: '⚡', threshold: { type: 'clicks', value: 1_000_000 } },
    { id: 'click_10m',    name: 'Legendary Clicker',  desc: 'Click 10,000,000 times', icon_img: 'sprites/images/icons/achievements/ach_click_10m.webp',      icon: '🔥', threshold: { type: 'clicks', value: 10_000_000 } },
    // Prestige milestones
    { id: 'prestige_1',   name: 'First Reset',        desc: 'Prestige once', icon_img: 'sprites/images/icons/achievements/ach_prestige_1.webp',               icon: '💎', threshold: { type: 'prestiges', value: 1 } },
    { id: 'prestige_3',   name: 'Triple Threat',      desc: 'Prestige 3 times', icon_img: 'sprites/images/icons/achievements/ach_prestige_3.webp',            icon: '♻️', threshold: { type: 'prestiges', value: 3 } },
    { id: 'prestige_5',   name: 'Veteran',            desc: 'Prestige 5 times', icon_img: 'sprites/images/icons/achievements/ach_prestige_5.webp',            icon: '🔷', threshold: { type: 'prestiges', value: 5 } },
    { id: 'prestige_10',  name: 'Prestige Master',    desc: 'Prestige 10 times', icon_img: 'sprites/images/icons/achievements/ach_prestige_10.webp',           icon: '💠', threshold: { type: 'prestiges', value: 10 } },
    { id: 'prestige_25',  name: 'Prestige Lord',      desc: 'Prestige 25 times', icon_img: 'sprites/images/icons/achievements/ach_prestige_25.webp',           icon: '👾', threshold: { type: 'prestiges', value: 25 } },
    { id: 'prestige_50',  name: 'Ascended Being',     desc: 'Prestige 50 times', icon_img: 'sprites/images/icons/achievements/ach_prestige_50.webp',           icon: '🌌', threshold: { type: 'prestiges', value: 50 } },
    // Room milestones
    { id: 'room_cyber',   name: 'Digital Denizen',    desc: 'Unlock the Cyber Den', icon_img: 'sprites/images/icons/achievements/ach_room_cyber.webp',        icon: '🖥️', threshold: { type: 'room', value: 'cyber_den' } },
    { id: 'room_zen',     name: 'Zen Master',         desc: 'Unlock the Zen Garden', icon_img: 'sprites/images/icons/achievements/ach_room_zen.webp',       icon: '🧘', threshold: { type: 'room', value: 'zen_garden' } },
    { id: 'room_star',    name: 'Stargazer',          desc: 'Unlock the Star Deck', icon_img: 'sprites/images/icons/achievements/ach_room_star.webp',        icon: '🔭', threshold: { type: 'room', value: 'star_deck' } },
    { id: 'room_study',   name: 'Scholar',            desc: 'Unlock the Study Lounge', icon_img: 'sprites/images/icons/achievements/ach_room_study.webp',     icon: '📚', threshold: { type: 'room', value: 'study_lounge' } },
    { id: 'room_beach',   name: 'Beachcomber',        desc: 'Unlock the Beach Cove', icon_img: 'sprites/images/icons/achievements/ach_room_beach.webp',       icon: '🏖️', threshold: { type: 'room', value: 'beach_cove' } },
    { id: 'room_all',     name: 'Everywhere At Once', desc: 'Unlock all 6 rooms', icon_img: 'sprites/images/icons/achievements/ach_room_all.webp',          icon: '🌐', threshold: { type: 'all_rooms', value: 1 } },
    // VPS milestones
    { id: 'vps_10',       name: 'Ten Per Second',     desc: 'Reach 10 VPS', icon_img: 'sprites/images/icons/achievements/ach_vps_10.webp',                icon: '🐢', threshold: { type: 'vps', value: 10 } },
    { id: 'vps_100',      name: 'Triple Digits',      desc: 'Reach 100 VPS', icon_img: 'sprites/images/icons/achievements/ach_vps_100.webp',               icon: '🚀', threshold: { type: 'vps', value: 100 } },
    { id: 'vps_1k',       name: 'Kilovibe',           desc: 'Reach 1K VPS', icon_img: 'sprites/images/icons/achievements/ach_vps_1k.webp',                icon: '💨', threshold: { type: 'vps', value: 1_000 } },
    { id: 'vps_10k',      name: 'Vibe Engine',        desc: 'Reach 10K VPS', icon_img: 'sprites/images/icons/achievements/ach_vps_10k.webp',               icon: '⚙️', threshold: { type: 'vps', value: 10_000 } },
    { id: 'vps_100k',     name: 'Vibe Turbine',       desc: 'Reach 100K VPS', icon_img: 'sprites/images/icons/achievements/ach_vps_100k.webp',              icon: '🏎️', threshold: { type: 'vps', value: 100_000 } },
    { id: 'vps_1m',       name: 'Vibe Factory',       desc: 'Reach 1M VPS', icon_img: 'sprites/images/icons/achievements/ach_vps_1m.webp',                icon: '🏭', threshold: { type: 'vps', value: 1_000_000 } },
    { id: 'vps_10m',      name: 'Vibe Metropolis',    desc: 'Reach 10M VPS', icon_img: 'sprites/images/icons/achievements/ach_vps_10m.webp',               icon: '🏙️', threshold: { type: 'vps', value: 10_000_000 } },
    { id: 'vps_100m',     name: 'Vibe Planet',        desc: 'Reach 100M VPS', icon_img: 'sprites/images/icons/achievements/ach_vps_100m.webp',              icon: '🌍', threshold: { type: 'vps', value: 100_000_000 } },
    { id: 'vps_1b',       name: 'Industrial Scale',   desc: 'Reach 1B VPS', icon_img: 'sprites/images/icons/achievements/ach_vps_1b.webp',                icon: '🌌', threshold: { type: 'vps', value: 1_000_000_000 } },
    // Gateway milestones
    { id: 'gw_first',     name: 'Gateway Connected',  desc: 'Connect to Hermes Gateway', icon_img: 'sprites/images/icons/achievements/ach_gw_first.webp',   icon: '🔌', threshold: { type: 'gateway', value: 1 } },
    { id: 'gw_quality',   name: 'Low Latency',        desc: 'Achieve <10ms gateway ping', icon_img: 'sprites/images/icons/achievements/ach_gw_quality.webp',  icon: '⚡', threshold: { type: 'gateway_low', value: 10 } },
    { id: 'gw_ultra',     name: 'Ultra Low Latency',  desc: 'Achieve <3ms gateway ping', icon_img: 'sprites/images/icons/achievements/ach_gw_ultra.webp',   icon: '💥', threshold: { type: 'gateway_low', value: 3 } },
    { id: 'gw_ping_100',  name: 'Ping Pro',           desc: 'Ping gateway 100 times', icon_img: 'sprites/images/icons/achievements/ach_gw_ping_100.webp',      icon: '📡', threshold: { type: 'pings', value: 100 } },
    { id: 'gw_ping_1k',   name: 'Ping Master',        desc: 'Ping gateway 1,000 times', icon_img: 'sprites/images/icons/achievements/ach_gw_ping_1k.webp',    icon: '🛰️', threshold: { type: 'pings', value: 1_000 } },
    // Decor milestones
    { id: 'decor_1',      name: 'First Decoration',   desc: 'Buy your first decor item', icon_img: 'sprites/images/icons/achievements/ach_decor_1.webp',   icon: '🎀', threshold: { type: 'decor', value: 1 } },
    { id: 'decor_5',      name: 'Decorator',          desc: 'Buy 5 decor items', icon_img: 'sprites/images/icons/achievements/ach_decor_5.webp',           icon: '🎨', threshold: { type: 'decor', value: 5 } },
    { id: 'decor_10',     name: 'Home Stager',        desc: 'Buy 10 decor items', icon_img: 'sprites/images/icons/achievements/ach_decor_10.webp',          icon: '🪑', threshold: { type: 'decor', value: 10 } },
    { id: 'decor_25',     name: 'Interior Designer',  desc: 'Buy 25 decor items', icon_img: 'sprites/images/icons/achievements/ach_decor_25.webp',          icon: '🏠', threshold: { type: 'decor', value: 25 } },
    { id: 'decor_50',     name: 'Collector',          desc: 'Buy 50 decor items', icon_img: 'sprites/images/icons/achievements/ach_decor_50.webp',          icon: '🏛️', threshold: { type: 'decor', value: 50 } },
    { id: 'decor_90',     name: 'Hoarder Supreme',    desc: 'Buy all 90 decor items', icon_img: 'sprites/images/icons/achievements/ach_decor_90.webp',      icon: '🏰', threshold: { type: 'decor', value: 90 } },
    // Autoclicker milestones
    { id: 'auto_10',      name: 'Automation Begins',  desc: 'Buy 10 total autoclickers', icon_img: 'sprites/images/icons/achievements/ach_auto_10.webp',   icon: '🤖', threshold: { type: 'autoclickers', value: 10 } },
    { id: 'auto_50',      name: 'Robot Army',         desc: 'Buy 50 total autoclickers', icon_img: 'sprites/images/icons/achievements/ach_auto_50.webp',   icon: '🦾', threshold: { type: 'autoclickers', value: 50 } },
    { id: 'auto_100',     name: 'Fully Automated',    desc: 'Buy 100 total autoclickers', icon_img: 'sprites/images/icons/achievements/ach_auto_100.webp',  icon: '🤖', threshold: { type: 'autoclickers', value: 100 } },
