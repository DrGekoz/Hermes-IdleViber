...
const ROOM_DECOR = {
    campfire_grove: [
        { id: 'cg_log_stool',        name: 'Log Stool',        cost: 500,    icon: 'cg_log_stool' },
        { id: 'cg_compass',          name: 'Compass',           cost: 1000,   icon: 'cg_compass' },
        { id: 'cg_canteen',          name: 'Canteen',           cost: 2000,   icon: 'cg_canteen' },
        { id: 'cg_whittle_figure',   name: 'Whittle Figure',    cost: 4000,   icon: 'cg_whittle_figure' },
        { id: 'cg_star_chart',       name: 'Star Chart',        cost: 8000,   icon: 'cg_star_chart' },
        { id: 'cg_map_stand',        name: 'Map Stand',         cost: 12000,  icon: 'cg_map_stand' },
        { id: 'cg_wildflower',       name: 'Wildflower Patch',  cost: 18000,  icon: 'cg_wildflower' },
        { id: 'cg_berry_bush',       name: 'Berry Bush',        cost: 25000,  icon: 'cg_berry_bush' },
        { id: 'cg_birdhouse',        name: 'Birdhouse',         cost: 35000,  icon: 'cg_birdhouse' },
        { id: 'cg_fishing_rod',      name: 'Fishing Rod',       cost: 50000,  icon: 'cg_fishing_rod' },
        { id: 'cg_axe_block',        name: 'Axe Block',         cost: 70000,  icon: 'cg_axe_block' },
        { id: 'cg_wood_pile',        name: 'Wood Pile',         cost: 100000, icon: 'cg_wood_pile' },
        { id: 'cg_bedroll',          name: 'Bedroll',           cost: 150000, icon: 'cg_bedroll' },
        { id: 'cg_lantern_post',     name: 'Lantern Post',      cost: 250000, icon: 'cg_lantern_post' },
        { id: 'cg_fire_ring',        name: 'Fire Ring',         cost: 500000, icon: 'cg_fire_ring' },
    ],
    cyber_den: [
        { id: 'cd_digital_clock',    name: 'Digital Clock',     cost: 500,    icon: 'cd_digital_clock' },
        { id: 'cd_glitch_art',       name: 'Glitch Art',        cost: 1000,   icon: 'cd_glitch_art' },
        { id: 'cd_circuit_board',    name: 'Circuit Board',     cost: 2000,   icon: 'cd_circuit_board' },
        { id: 'cd_cooling_fan',      name: 'Cooling Fan',       cost: 4000,   icon: 'cd_cooling_fan' },
        { id: 'cd_data_crystal',     name: 'Data Crystal',      cost: 8000,   icon: 'cd_data_crystal' },
        { id: 'cd_rgb_panel',        name: 'RGB Panel',         cost: 12000,  icon: 'cd_rgb_panel' },
        { id: 'cd_vr_headset',       name: 'VR Headset',        cost: 18000,  icon: 'cd_vr_headset' },
        { id: 'cd_keyboard_rig',     name: 'Keyboard Rig',      cost: 25000,  icon: 'cd_keyboard_rig' },
        { id: 'cd_cable_spaghetti',  name: 'Cable Spaghetti',   cost: 35000,  icon: 'cd_cable_spaghetti' },
        { id: 'cd_server_tower',     name: 'Server Tower',      cost: 50000,  icon: 'cd_server_tower' },
        { id: 'cd_power_core',       name: 'Power Core',        cost: 70000,  icon: 'cd_power_core' },
        { id: 'cd_access_terminal',  name: 'Access Terminal',   cost: 100000, icon: 'cd_access_terminal' },
        { id: 'cd_projector_screen', name: 'Projector Screen',  cost: 150000, icon: 'cd_projector_screen' },
        { id: 'cd_robot_arm',        name: 'Robot Arm',         cost: 250000, icon: 'cd_robot_arm' },
        { id: 'cd_holographic_display', name: 'Hologram Display', cost: 500000, icon: 'cd_holographic_display' },
    ],
    zen_garden: [
        { id: 'zg_tea_set',          name: 'Tea Set',           cost: 500,    icon: 'zg_tea_set' },
        { id: 'zg_water_dipper',     name: 'Water Dipper',      cost: 1000,   icon: 'zg_water_dipper' },
        { id: 'zg_incense_burner',   name: 'Incense Burner',    cost: 2000,   icon: 'zg_incense_burner' },
        { id: 'zg_lotus_flower',     name: 'Lotus Flower',      cost: 4000,   icon: 'zg_lotus_flower' },
        { id: 'zg_wind_chime',       name: 'Wind Chime',        cost: 8000,   icon: 'zg_wind_chime' },
        { id: 'zg_meditation_cush',  name: 'Meditation Cushion',cost: 12000,  icon: 'zg_meditation_cush' },
        { id: 'zg_moss_rock',        name: 'Moss Rock',         cost: 18000,  icon: 'zg_moss_rock' },
        { id: 'zg_cherry_bonsai',    name: 'Cherry Bonsai',     cost: 25000,  icon: 'zg_cherry_bonsai' },
        { id: 'zg_bamboo_fence',     name: 'Bamboo Fence',      cost: 35000,  icon: 'zg_bamboo_fence' },
        { id: 'zg_stone_path',       name: 'Stone Path',        cost: 50000,  icon: 'zg_stone_path' },
        { id: 'zg_koi_pond',         name: 'Koi Pond',          cost: 70000,  icon: 'zg_koi_pond' },
        { id: 'zg_sand_garden',      name: 'Sand Garden',       cost: 100000, icon: 'zg_sand_garden' },
        { id: 'zg_rain_chain',       name: 'Rain Chain',        cost: 150000, icon: 'zg_rain_chain' },
        { id: 'zg_bamboo_fountain',  name: 'Bamboo Fountain',   cost: 250000, icon: 'zg_bamboo_fountain' },
        { id: 'zg_stone_lantern',    name: 'Stone Lantern',     cost: 500000, icon: 'zg_stone_lantern' },
    ],
    star_deck: [
        { id: 'sd_moon_globe',       name: 'Moon Globe',        cost: 500,    icon: 'sd_moon_globe' },
        { id: 'sd_constellation_map',name: 'Constellation Map', cost: 1000,   icon: 'sd_constellation_map' },
        { id: 'sd_meteor_stone',     name: 'Meteor Stone',      cost: 2000,   icon: 'sd_meteor_stone' },
        { id: 'sd_orbit_diagram',    name: 'Orbit Diagram',     cost: 4000,   icon: 'sd_orbit_diagram' },
        { id: 'sd_astrolabe',        name: 'Astrolabe',         cost: 8000,   icon: 'sd_astrolabe' },
        { id: 'sd_galaxy_painting',  name: 'Galaxy Painting',   cost: 12000,  icon: 'sd_galaxy_painting' },
        { id: 'sd_observatory_chair',name: 'Observatory Chair', cost: 18000,  icon: 'sd_observatory_chair' },
        { id: 'sd_star_projector',   name: 'Star Projector',    cost: 25000,  icon: 'sd_star_projector' },
        { id: 'sd_lunar_lamp',       name: 'Lunar Lamp',        cost: 35000,  icon: 'sd_lunar_lamp' },
        { id: 'sd_cosmic_map',       name: 'Cosmic Map',        cost: 50000,  icon: 'sd_cosmic_map' },
        { id: 'sd_nebula_art',       name: 'Nebula Art',        cost: 70000,  icon: 'sd_nebula_art' },
        { id: 'sd_planet_model',     name: 'Planet Model',      cost: 100000, icon: 'sd_planet_model' },
        { id: 'sd_rocket_model',     name: 'Rocket Model',      cost: 150000, icon: 'sd_rocket_model' },
        { id: 'sd_satellite_dish',   name: 'Satellite Dish',    cost: 250000, icon: 'sd_satellite_dish' },
        { id: 'sd_telescope',        name: 'Telescope',         cost: 500000, icon: 'sd_telescope' },
    ],
    study_lounge: [
        { id: 'sl_coffee_mug',       name: 'Coffee Mug',        cost: 500,    icon: 'sl_coffee_mug' },
        { id: 'sl_candle_holder',    name: 'Candle Holder',     cost: 1000,   icon: 'sl_candle_holder' },
        { id: 'sl_plant_pot',        name: 'Plant Pot',         cost: 2000,   icon: 'sl_plant_pot' },
        { id: 'sl_wall_clock',       name: 'Wall Clock',        cost: 4000,   icon: 'sl_wall_clock' },
        { id: 'sl_typewriter',       name: 'Typewriter',        cost: 8000,   icon: 'sl_typewriter' },
        { id: 'sl_globe',            name: 'Globe',             cost: 12000,  icon: 'sl_globe' },
        { id: 'sl_throw_pillow',     name: 'Throw Pillow',      cost: 18000,  icon: 'sl_throw_pillow' },
        { id: 'sl_magazine_rack',    name: 'Magazine Rack',     cost: 25000,  icon: 'sl_magazine_rack' },
        { id: 'sl_picture_frame',    name: 'Picture Frame',     cost: 35000,  icon: 'sl_picture_frame' },
        { id: 'sl_reading_lamp',     name: 'Reading Lamp',      cost: 50000,  icon: 'sl_reading_lamp' },
        { id: 'sl_floor_lamp',       name: 'Floor Lamp',        cost: 70000,  icon: 'sl_floor_lamp' },
        { id: 'sl_record_player',    name: 'Record Player',     cost: 100000, icon: 'sl_record_player' },
        { id: 'sl_writing_desk',     name: 'Writing Desk',      cost: 150000, icon: 'sl_writing_desk' },
        { id: 'sl_armchair',         name: 'Armchair',          cost: 250000, icon: 'sl_armchair' },
        { id: 'sl_bookshelf',        name: 'Bookshelf',         cost: 500000, icon: 'sl_bookshelf' },
    ],
    beach_cove: [
        { id: 'bc_seashell',         name: 'Seashell',          cost: 500,    icon: 'bc_seashell' },
        { id: 'bc_starfish',         name: 'Starfish',          cost: 1000,   icon: 'bc_starfish' },
        { id: 'bc_sand_bucket',      name: 'Sand Bucket',       cost: 2000,   icon: 'bc_sand_bucket' },
        { id: 'bc_flip_flops',       name: 'Flip Flops',        cost: 4000,   icon: 'bc_flip_flops' },
        { id: 'bc_beach_ball',       name: 'Beach Ball',        cost: 8000,   icon: 'bc_beach_ball' },
        { id: 'bc_driftwood',        name: 'Driftwood',         cost: 12000,  icon: 'bc_driftwood' },
        { id: 'bc_sandcastle',       name: 'Sandcastle',        cost: 18000,  icon: 'bc_sandcastle' },
        { id: 'bc_coral_piece',      name: 'Coral Piece',       cost: 25000,  icon: 'bc_coral_piece' },
        { id: 'bc_tiki_torch',       name: 'Tiki Torch',        cost: 35000,  icon: 'bc_tiki_torch' },
        { id: 'bc_cooler',           name: 'Cooler',            cost: 50000,  icon: 'bc_cooler' },
        { id: 'bc_beach_towel',      name: 'Beach Towel',       cost: 70000,  icon: 'bc_beach_towel' },
        { id: 'bc_surfboard',        name: 'Surfboard',         cost: 100000, icon: 'bc_surfboard' },
        { id: 'bc_beach_umbrella',   name: 'Beach Umbrella',    cost: 150000, icon: 'bc_beach_umbrella' },
        { id: 'bc_hammock',          name: 'Hammock',           cost: 250000, icon: 'bc_hammock' },
        { id: 'bc_palm_tree',        name: 'Palm Tree',         cost: 500000, icon: 'bc_palm_tree' },
    ],
};
